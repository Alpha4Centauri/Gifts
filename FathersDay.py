...
if a.lower() == "yes":
  ...
  if b == "Happy Father's Day!":
    print("You got it, the answer is Happy Father's Day!")
if a.lower() == "no":
  print("I've given you one hint, I'll now give you another")
  time.sleep(5)
  clear()

  print("What greeting happens every 60% through June?")
...
if a.lower() == "no":
  ...
  if time_limit == 0:
    ...
    if a.lower() == "yes":
      ...
      print("If you haven't gotten it by now, the answer is Happy Father's Day!")
      time.sleep(5)